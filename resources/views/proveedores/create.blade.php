        ...
        <div class="flex items-center justify-between animate-slide-up">
            <div>
                <h2 class="text-4xl font-bold font-display gradient-text">
                    {{ __('Registrar Prospecto de Proveedor') }}
                </h2>
        ...
        <div class="modern-card">
            ...
            <div class="modern-card-body">
                @php
                    ...
                    $tiposIniciales = old('tipos_unidades', []);
                    $cantidadesIniciales = old('cantidades_unidades', []);
                ...
                @endphp
                <form action="{{ route('proveedores.store') }}" method="POST" x-data="{ 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <x-form-input
                            ...
                            value="{{ old('base_linea_transporte') }}"
                        ...
                        <x-form-input
                            ...
                            value="{{ old('corredor_linea_transporte') }}"
                        ...
                        <x-form-input
                            ...
                            value="{{ old('nombre_quien_registro') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="space-y-3 mt-2">
                                @php
                                    ...
                                    $oldTipos = old('tipos_unidades', []);
                                    $oldCantidades = old('cantidades_unidades', []);
                                @endphp
